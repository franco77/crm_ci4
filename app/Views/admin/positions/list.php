        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <button class="btn btn-sm btn-primary form-action" purpose="add">Nuevo</button>
                </div>
                <table id="datatable" class="table table-sm activate-select">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Aquí puedes añadir el contenido del cuerpo del modal -->
            </div>
        </div>
    </div>
</div>
