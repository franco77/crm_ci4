                ...
                <div class="col-sm-9">
                    <div class="tab-content pt-0">
                        <div class="tab-pane fade active show" id="v-pills-dataCompany" role="tabpanel"
                            ...
                            <form id="form-dataCompany" action="<?= base_url('admin/settings/dataCompanySettings') ?>"
                                method="post">
                        ...
                        <div class="tab-pane fade" id="v-pills-logo" role="tabpanel" aria-labelledby="v-pills-logo-tab">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="<?= base_url('admin/settings/upload') ?>"
                                    ...
                                    <div id="preview" class="mt-3" style="display:none;">
                                        <h6>Vista previa:</h6>
                                        <img id="previewImage" src="#" alt="Vista previa del logo" class="img-thumbnail"
                        ...
                        <div class="tab-pane fade" id="v-pills-formats" role="tabpanel"
                            ...
                            <div id="message-container"></div>
                            <form id="form-formats" action="<?= base_url('admin/settings/formatsSettings') ?>"
                                method="post">
                                <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="v-pills-otherSettings" role="tabpanel"
                            ...
                            <div id="message-container"></div>
                            <form id="form-otherSettings" action="<?= base_url('admin/settings/otherSettings') ?>"
                                method="post">
