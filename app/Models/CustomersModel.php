...
class CustomersModel extends Model
{
   ...
   protected $allowedFields = ['ic', 'first_name', 'last_name', 'email', 'phone_number', 'address', 'city', 'state', 'postal_code', 'country', 'created_at'];
   protected $searchFields = ['ic', 'first_name', 'last_name', 'email', 'phone_number'];
   ...
   public function filter($search = null, $limit = null, $start = null, $orderField = null, $orderDir = null)
   {
      ...
      $orderField = in_array($orderField, $this->allowedFields) ? $orderField : 'first_name';
      ...
      $builder->select('id, ic, first_name, last_name, email, phone_number')
