...
class Invoices extends BaseController
{
   ...
   {
      $customerId = $this->request->getPost('client_id');

      // Utiliza Ion Auth para buscar el usuario por su ID
      $customerDetails = $this->ionAuth->user($customerId)->row(); // Busca el usuario por ID
   ...
   public function create()
   {
      ...
      if ($this->validation->run($request) === FALSE) {
         ...
         try {
            ...
            $product_images = $this->request->getPost('product_image') ?? [];
